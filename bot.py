...
async def run_bot(transport: BaseTransport, runner_args: RunnerArguments):
    ...
    llm = create_llm(
        system_instruction=(
            ...
            "NEVER call place_bet during your greeting or before the player has explicitly told you an amount to bet. "
            "Only call place_bet after the player has said a specific number (e.g. 'I bet 10', 'bet 20 chips', 'ten', 'all in'). "
